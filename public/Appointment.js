...
function make_appointment() {   //main function after clicking submit
    if (is_empty() == false) {
        is_past_date();
        compare();
        if (is_overlap() == false) {
            ...
            clear_input();
            iziToast.success({     //------------------alert message
                title: 'Success',
            ...
            iziToast.error({
                title: 'Error',
                message: "This appointment is overlaping with another one",
                overlay: true,
                zindex: 999,
                position: 'center',
                timeout: 3000,
